...
if [ ! -f "$builder_path/$OUTPUT_APK" ]; then
  ...
  CANDIDATES=(
    ...
    "$builder_path/Library/Bee/Android/Prj/IL2CPP/Gradle/launcher/build/outputs/apk/release/*.apk"
    "$builder_path/Library/Bee/Android/Prj/IL2CPP/Gradle/launcher/build/outputs/apk/**/*.apk"
    "$builder_path/Temp/gradleOut/launcher/build/outputs/apk/release/launcher-release.apk"
    "$builder_path/Temp/gradleOut/launcher/build/outputs/apk/**/*.apk"
  )
