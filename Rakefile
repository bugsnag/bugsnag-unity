...
def assemble_android filter_abis=true
  ...
  mv sdk_aar, File.join("bugsnag-android/sdk/build/outputs/aar/bugsnag-android-release.aar")
  mv ndk_aar, File.join("bugsnag-android/ndk/build/outputs/aar/bugsnag-android-ndk-release.aar")
