...
namespace BugsnagUnity
{
    internal class Il2cppUtils
    {
        ...
        internal static IntPtr GHandle_Get_Target(IntPtr gchandle) => il2cpp_gchandle_get_target(gchandle);

#elif ENABLE_IL2CPP && UNITY_2021_3_OR_NEWER

        [DllImport("__Internal")]
        private static extern IntPtr il2cpp_gchandle_get_target(int gchandle);
        internal static IntPtr GHandle_Get_Target(IntPtr gchandle) => il2cpp_gchandle_get_target(gchandle.ToInt32());
        ...
        internal static void Free(IntPtr ptr) => il2cpp_free(ptr);
        ...
        internal static void NativeStackTrace(IntPtr exc, out IntPtr addresses, out int numFrames, out IntPtr imageUUID, out IntPtr imageName) =>
            il2cpp_native_stack_trace(exc, out addresses, out numFrames, out imageUUID, out imageName);

        #nullable enable
        internal static string? ExtractString(IntPtr pString, Int32 iLimit)
        {
            return (pString == IntPtr.Zero) ? null : Marshal.PtrToStringAnsi(pString, iLimit);
        }
        #nullable disable

        internal static Int32 FindStringTerminator(IntPtr pString, string terminator)
        {
        ...
        internal static StackTraceLine[] ToStackFrames(System.Exception exception, Func<System.Exception, IntPtr[], String, String, StackTraceLine[]> stackTransformer)
        {
             ...
             try
             {
                 ...
                 Il2cppUtils.NativeStackTrace(pException, out pNativeAddresses, out frameCount, out pImageUuid, out pImageName);
